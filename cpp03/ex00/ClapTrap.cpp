...
void ClapTrap::attack(const std::string& target)
{
	...
	{
		std::cout<<"ClapTrap is short of Energy points!!"<<std::endl;
		return ;
	}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (this->energy_points <= 0 || this->hit_points <= 0)
	{
		std::cout<<"ClapTrap is in short of Energy points!!"<<std::endl;
		return ;
	}
	std::cout<<"ClapTrap "<<this->name<<" repaired and gained "<<amount<<" hit_points!"<<std::endl;
	this->energy_points -= 1;
	this->hit_points += amount;
}
